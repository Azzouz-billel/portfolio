...
export const profile = {
  ...
  socials: [
    { label: 'GitHub', url: 'https://github.com/Azzouz-billel' },
    { label: 'LinkedIn', url: 'https://www.linkedin.com/in/billel-azzouz-1a6aa0302/' },
    { label: 'Email', url: 'mailto:billel.azzouz@nhsm.edu.dz' },
  ],
}
